...
class Empleado{
    ...
    public static function Agregar($empleado){
        ...
        if (isset($empleado)) {
            ...
            $sql = "INSERT INTO personas (legajo,nombre,apellido,sexo,sueldo,foto) VALUES (:legajo,:nombre,:apellido,:sexo,:sueldo,:foto)";
    ...
    public static function Eliminar($empleado){
        ...
        if (isset($empleado)) {
            ...
            $sql = "DELETE FROM personas WHERE legajo = $empleado->legajo";
    ...
    public static function Modificar($empleado){
        ...
        if (isset($empleado)) {
            ...
            $sql = "UPDATE personas SET nombre = '$empleado->nombre', apellido = '$empleado->apellido', sueldo = $empleado->sueldo WHERE legajo = $empleado->legajo";
